const serviceActions={
    ...
    add_truck_type:"ADD_TRUCK_TYPE",
    add_truck_type_err:"ADD_TRUCK_TYPE_ERR",
    update_truck_type:"UPDATE_TRUCK_TYPE",
    update_truck_type_err:"UPDATE_TRUCK_TYPE_ERR",
    delete_truck_type:"DALETE_TRUCK_TYPE",
    delete_truck_type_err:"DALETE_TRUCK_TYPE_ERR",
    get_truck_type_details:"GET_TRUCK_TYPE_DETAILS",
    get_truck_type_details_err:"GET_TRUCK_TYPE_DETAILS_ERR",
    get_goods_types:"GET_GOODS_TYPES",
    get_goods_types_err:"GET_GOODS_TYPES_ERR",
    add_goods_type:"ADD_GOODS_TYPE",
    add_goods_type_err:"ADD_GOODS_TYPE_ERR",
    update_goods_type:"UPDATE_GOODS_TYPE",
    update_goods_type_err:"UPDATE_GOODS_TYPE_ERR",
    delete_goods_type:"DALETE_GOODS_TYPE",
    delete_goods_type_err:"DALETE_GOODS_TYPE_ERR",
    get_goods_type_details:"GET_GOODS_TYPE_DETAILS",
    get_goods_type_details_err:"GET_GOODS_TYPE_DETAILS_ERR",
    get_load_types:"GET_LOAD_TYPES",
    get_load_types_err:"GET_LOAD_TYPES_ERR",
    add_load_type:"ADD_LOAD_TYPE",
    add_load_type_err:"ADD_LOAD_TYPE_ERR",
    update_load_type:"UPDATE_LOAD_TYPE",
    update_load_type_err:"UPDATE_LOAD_TYPE_ERR",
